...
const Yamas = () => {
  ...
  return (
    <div>
      ...
      <div className="uk-flex split">
        <div
          className="uk-padding sticky-column"
          data-uk-sticky="end: !.split; offset: 80;"
        >
          <ul data-uk-tab className="uk-padding-horizontal blue-tab column-tab">
            <li>
            ...
            <li>
              <a href="#" onClick={() => scrollToSection(feedback)}>
                USER FEEDBACK
              </a>
            </li>
            <li>
        ...
        <div className="text-column">
          ...
          >
            <div className=" uk-margin-large uk-padding">
              ...
              <p>
                Yamas makes it easy for patients to schedule appointments with
                healthcare providers. With just a few taps on their smartphone,
                patients can browse available appointment times, select a date
                and time that works for them, and book their appointment
              ...
              <p>
                ...
                staff also have a difficult time assisting patients with the
                booking process, leading to inefficiencies and increased
                workload.
              </p>
              <div className="uk-padding-remove">
                ...
                <ul className="tasks">
                  ...
                  <li>
                    Design Execution and validation of the homepage, standard
                    and priority booking flow and sign up & sign in.
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="uk-section uk-container uk-padding-remove-vertical">
            <div className="uk-padding uk-padding-remove-bottom uk-margin-bottom uk-flex">
              ...
              <div>
                <p>
                  Working together with the research team, we uncovered a number
                  of pain points with the healthcare appointment booking
                  process. Patients found the process to be time-consuming,
                  among others. Hospital administration also highlighted that
                  they had to spend a lot of time on the phone assisting
                  patients with the booking process.
                </p>
                <h4>
          ...
          <div className="uk-section uk-container uk-padding-remove-vertical">
            <div className="uk-padding uk-padding-remove-bottom">
              ...
              <p className="uk-margin-remove">
                The first step was to have a deep look at user needs and
                behaviour. To gather insights on how we would best design the
                Yamas app, the research team conducted user research through a
                variety of methods, including online surveys and focus groups.
              </p>
            </div>
          </div>
          <div className="uk-section uk-container uk-padding-remove-vertical">
          ...
          <div className="uk-section uk-container uk-padding-remove-vertical">
            <div className="uk-padding">
              <h2 className="header-text uk-margin-remove-bottom">
                02 Personas
              </h2>
              <div
                className="study-image uk-margin-bottom"
          ...
          <div className="uk-section uk-container uk-padding-remove-vertical">
            <div className="uk-padding">
              ...
              <p>
                Together with the research team, we conducted market analysis of
                our competitors who are already on the market to identify areas
                where user experience on our app can be improved in order to
                stand out in the market. We discovered quite a number of apps
                that served similar purpose but we downsized our analysis to 3
                prominent apps.
              </p>
              <div className="study-image" data-uk-lightbox="animation: fade">
                <a href={companal}>
          ...
          <div className="uk-section uk-container uk-padding-remove-vertical">
            <div className="uk-padding" ref={ideation}>
              <h3 className="header-text uk-margin-remove-bottom">
                04 Feature Ideation
              </h3>
              <p>
                Using a pyramid of advantage, we brainstormed various features
                and evaluated them based on benefit and value to our target
                users. We then grouped these features by Must Have, Nice to Have
                and Love to Have, emphasizing the Love to Haves and Must-Haves.
                The competitor analysis allowed us to examine key features from
                competitors that we could include and features that we could
                avoid.
              </p>
            </div>
          </div>
          <div className="uk-section-large uk-container uk-padding-remove-top">
            <div className="uk-padding">
              ...
              <p>
                ...
                high-level hierarchy of the app's content, structuring the
                necessary information that needed to be displayed and how our
                users would access that information. It was a bit challenging at
                this point considering the 2 different types of booking
                processes a user had to choose from. The main concern was how to
                stucture the information to reduce the number of pages to be
                navigated, making it more user-friendly.
              </p>
              <div className="study-image" data-uk-lightbox="animation: fade">
          ...
          <div className="uk-section-large uk-container uk-padding-remove-bottom">
            <div className="uk-padding">
              ...
              <p>
                With the information architecture done, I moved on to mapping
                out the different steps and interactions that my user would go
                through as they use the app. This would help me understand their
                needs and goals at every touch point, as well as identify any
                potential bottlenecks in my user’s journey that could be
                addressed.
              </p>
              <div className="study-image" data-uk-lightbox="animation: fade">
                <a href={userJourney}>
          ...
          <div className="uk-section uk-container uk-padding-remove-vertical">
            <div className="uk-padding">
              ...
              <p>
                When it was time to integrate color, text and other UI elements
                into the wireframes, I based most design decisions on mitigating
                risks, the most important being people not being able to use the
                interface. The main things to look out for were accessibility,
                reducing interaction cost and minimising cognitive overload.
              </p>
            </div>
          </div>
          <div className="uk-section uk-container uk-padding-remove-vertical">
            <div className="uk-padding">
              ...
              <p>
                At this point, I was ready to carve out mid-fidelity wireframes
                of the solution, reason being that i had already created low
                fidelity blue prints together with the information architecture.
              </p>
              <div
                className="study-image uk-margin-bottom"
                data-uk-lightbox="animation: fade"
          ...
          <div className="uk-section uk-container uk-padding-remove-vertical">
            <div className="uk-padding">
              ...
              <p>
                One key design decision was to simplify the sign up process so
                not to scare new users away. Sign Up
              </p>
              <div
                className="study-image uk-margin-bottom"
                data-uk-lightbox="animation: fade"
          ...
          <div className="uk-section uk-container uk-padding-remove-vertical">
            <div className="uk-padding">
              ...
              <p>
                Based on the subscription model of the app, booking an
                appointment with a healthcare provider involved 2 distinct
                processes or categories. The standard process of booking
                appointments which automatically selects time for users while
                priority booking gives a user the flexibility to choose their
                own date and time.
              </p>
              <div
                className="study-image uk-margin-bottom"
          ...
          <div className="uk-section uk-container uk-padding-remove-vertical">
            <div className="uk-padding">
              ...
              <p>
                ...
                valuable insights into the user experience of the app and
              ...
              <p>
                Overall, the results of the usability testing study were
                positive. 7 out of 10 users were able to complete the tasks with
                minimal difficulty, and had high levels of satisfaction with the
                app. What they liked most were:
              </p>
              <ul>
                <li>The interface was simple and consistent.</li>
                <li>
                  The app was quite easy to navigate in order to perform key
                  tasks.
                </li>
                <li>
              ...
              <ul>
                <li>
                  An edit button could be provided under Complaint text box to
                  allow users edit text
                </li>
                <li></li>
              </ul>
            </div>
          ...
          <div className="uk-section-large uk-container">
            <div className="uk-padding">
              ...
              <p>
                it was interesting to see which motivations, how many contexts
                and use cases triggered users to open the Yamas App to book
                health care appointments.
              </p>
              <p>
                Again, it is important to consider the specific needs and
                preferences of target users when designing an app. The Yamas
                health care booking app was designed with the goal of making it
                easy for patients to manage their health care appointments and
                personal information and understanding needs and expectations of
                our set of users was crucial in the design process
              </p>
